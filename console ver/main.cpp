	...
	public:
		...
		void scene7()
	{
		cout << "Day 25 The Pedophile" << endl;
		Sleep(3000);
		cout << "[Jerome]: Kid wake up.\n" << endl;
		Sleep(3000);
		cout << "[MC]: Huh?\n" << endl;
		Sleep(3000);
		cout << "[Jerome]: It's morning already. You should head home and get ready for shcool.\n" << endl;
		Sleep(3000);
		cout << "Inner Monologue" << endl;
		cout << "Cath's not here, she probably woke up and got back to her room last night.\n" << endl;
		Sleep(3000);
		cout << "[MC]: Goodbye sir, I can't thank you enough for everything you did for me.\n" << endl;
		Sleep(3000);
		cout << "[Jerome]: No problem kid.\n" << endl;
		Sleep(3000);
		cout << "[MC]: Where's Cath? I should say goodbye to her.\n" << endl;
		Sleep(3000);
		cout << "[Jerome]: Oh, she already left already today. She said she had some schoo assembly to attend and she said that she didn't want to wake you up...See you kid.\n" << endl;
		Sleep(3000);
		cout << "Inner Monologue" << endl;
		cout << "While I was heading home, I walked by a police precinct. I can see familiar faces inside, so I decided to know what's going on.\n" << endl;
		Sleep(3000);
		cout << "[Policeman]: Dud that was messed up. Why would you do that to a student.\n" << endl;
		Sleep(3000);
		cout << "Inner Monologue" << endl;
		cout << "Whoa! Is that Mr.Sammy? Did he get arrested or something?\n" << endl;
		Sleep(3000);
		cout << "[Ms.Joan]: Hey " << name << ", what're you doing here?\n" << endl;
		Sleep(3000);
		cout << "[MC]: i was just walking by and I saw something interesting so I stopped by. Do you know what happened?\n" << endl;
		Sleep(3000);
		cout << "[Ms.Joan]: Yeah, first let's get out of the precinct.\n" << endl;
		Sleep(3000);
		cout << "TRIGGER WARNING" << endl;
		Sleep(3000);
		cout << "Responses\n[1] Continue\n[2] Skip scene read TL;DR" << endl;
		...
		while(true)
		{
			...
			{
				Sleep(3000);
				cout << "[MC]: So what happend?\n" << endl;
				Sleep(3000);
				cout << "[Ms.Joan]: Well it happened earlier. The student council was having a meeting.\n" << endl;
				cout << "[Ms.Joan]: Then Mr.Sammy called one of the officers. I didn't heard exactly what happened but they said that he attempted to rape the student. Good thing the student shouted.\n" << endl;
				Sleep(3000);
				cout << "[Mr.Joan]: Sir Marco immediately responded. We all heard the shout from the teacher's lounge.\n" << endl;
				break;
			}
			else if (None == "2")
			{
				Sleep(3000);
				cout << "Sammy got arrested for harassment. A brave teacher saved a student. Poliec confirmed that he is a pedophile. Ms.Joan told you what happened.\n" << endl;
				break;
			}
			else
			{
		...
		Sleep(3000);
		cout << "[MC]: Wait. who was the student? Is she okay?\n" << endl;
		Sleep(3000);
		cout << "[Ms.Joan]: I'm sorry " << name << ", I don't really know who it was. It all happened so fast. They told some of us to go here to be a witness and they took my testimony.\n" << endl;
		Sleep(3000);
		cout << "[MC]: I need to hurry, Thanks Ms.Joan goodbye.\n" << endl;
		Sleep(3000);
		cout << "Inner Monologue" << endl;
		cout << "I head to the school immediately. I didn't bother to get home. I still wear the uniform I wore yesterday.\n" << endl;
		cout << "I'm panicking right now. I need to see if she's okay.\n" << endl;
		Sleep(3000);
		cout << "I got to our room, Cath was not there. I got into the student council, she's not there either.\n" << endl;
		cout << "Where could she be?\n" << endl;
		Sleep(3000);
		cout << "You can't find Cath so you sit down in the classroom...\n" << endl;
		Sleep(3000);
		cout << "[Cath]: Good morning.\n" << endl;
		Sleep(3000);
		cout << "[MC]: Cath... are you okay? *You hugged her without having any second thoughts*\n" << endl;
		Sleep(3000);
		cout << "[Cath]: Uhh...Hey, what happened?\n" << endl;
		Sleep(3000);
		cout << "[MC]: I thought something bad might have happened to you. I can't bear it.\n" << endl;
		Sleep(3000);
		cout << "[Cath]: What? No, I'm fine. What happened.\n" << endl;
		Sleep(3000);
		cout << "You told her the whole story.\n" << endl;
		Sleep(3000);
		cout << "[Cath]: Oh. Sorry for making you worry like that. I didn't know I was at the Rhonson's mall with Remy.\n" << endl;
		Sleep(3000);
		cout << "[Cath]: We were video chatting with mom and aunt from Canada.\n" << endl;
		Sleep(3000);
		cout << "[MC]: I'm so glad you're fine.\n" << endl;
		Sleep(3000);
		cout << "...\n" << endl;
		Sleep(3000);
		cout << "[???]: Good morning class.\n" << endl;
		Sleep(3000);
		cout << "[Classmate 1]: Who's that?\n" << endl;
		Sleep(3000);
		cout << "[Classmate 2]: He's hot.\n" << endl;
		Sleep(3000);
		cout << "[Classmate 3]: I know right?\n" << endl;
		Sleep(3000);
		cout << "[Class]: *chatters*\n" << endl;
		Sleep(3000);
		cout << "[Sir Marco]: As you know something happened earlier. To those who didn't. Let's just leave it that way.\n" << endl;
		cout << "[Sir Marco]: Starting today onward, I'll be your class adviser for this semester.\n" << endl;
		Sleep(3000);
		cout << "[Classmate 2]: I won't take absences anymore.\n" << endl;
		Sleep(3000);
		cout << "[Cath]: Good thing they arrested taht perverted old guy. I was sick of that man.\n" << endl;
		Sleep(3000);
		cout << "[MC]: I totally agree. Out new class adviser seems like a cool teacher.\n" << endl;
		Sleep(3000);
		cout << "[Sir Marco]: I know you have a presentation for tomorrow and the school is really busy right now and we're having so many problems so you should head home for today.\n" << endl;
		cout << "[Sir Marco]: I'll move the presentation next month, March 3rd, Wednesday.\n" << endl;
		Sleep(3000);
		cout << "[Sir Marco]: There might be no classes for tomorrow as well so wait for further announcements.\n" << endl;
		Sleep(3000);
		cout << "Inner Monologue" << endl;
		cout << "Good grief, that was a heck of a day. I head home with Cath.\n" << endl;
		Sleep(3000);
		cout << "[Cath]: Hey uhm " << name << ". C-can I ask you something.\n" << endl;
		Sleep(3000);
		cout << "[MC]: Sure.\n" << endl;
		Sleep(3000);
		cout << "[Cath]: So next Sunday is my birthday. I don't really celebrate birthdays, but can you hang out with me.\n" << endl;
		Sleep(3000);
		cout << "Responses\n[1] Pass, I'm busy.\n[2] So it's a Date?" << endl;
		cout << "Option: ";
		getline(cin, None);
		...
		while(true)
		{
			...
			{
				Sleep(3000);
				cout << "Cath was sad because I didn't hang out with her. She was probably mad with me." << endl;
				cout << "She became cold to me so fast. Later I found out that she started dating Von.\n" << endl;
				void game_over();
				break;
			}
			else if (None == "2")
	...
	void scene8()
	{
		...
		cout << "Day 28 The End?\n" << endl;
		Sleep(3000);
		cout << "Today is Cath's Birthday. I took her on a date. I asked my dad for an advance allowance so I could treat Cath.\n" << endl;
		cout << "I also want to giver her something specia for tonight. At the top of Hakone Mountain in Onsen Town.\n" << endl;
		Sleep(3000);
		cout << "*Knock at the door*\n" << endl;
		Sleep(3000);
		cout << "[Cath]: Coming.\n" << endl;
		Sleep(3000);
		cout << "Inner Monologue" << endl;
		cout << "As she opened the door I was struck by her appearance. She wore a casual black blouse and a cardigan.\n" << endl;
		Sleep(3000);
		cout << "Yet she looks like a Goddess who stepped down on Earth just to give me a date.\n" << endl;
		Sleep(3000);
		cout << "Responses\n[1] You look great...\n[2] ..." << endl;
		cout << "Option: ";
		getline(cin, None);
		...
		while(true)
		{
			...
			{
				Sleep(3000);
				cout << "[Cath]: Thanks, you too.\n" << endl;
				Sleep(3000);
				cout << "[MC]: I mean my eyes should be a mirror so you could know how I see you.\n" << endl;
				Sleep(3000);
				cout << "[Cath]: *blushes*\n" << endl;
				break;
			}
			...
			{
				Sleep(3000);
				cout << "[Cath]: Hey, I said let's go.\n" << endl;
				Sleep(3000);
				cout <<"[MC]: I'm so sorry, I was too stunned to speak. I wanted to say; Happy birthdya.\n" << endl;
				Sleep(3000);
				cout << "[Cath]: Thanks.\n" << endl;
				break;
			}
		...
		Sleep(3000);
		cout << "[Jerome]: Hey, take my daughter home safely.\n" << endl;
		Sleep(3000);
		cout << "[MC]: Yes sir!\n" << endl;
		Sleep(3000);
		cout << "Art Museum" << endl;
		Sleep(3000);
		cout << "[MC]: M'lady first let's go in here.\n" << endl;
		Sleep(3000);
		cout << "[Cath]: Wow, an art gallery. It's been a long time since I've been in one.\n" << endl;
		Sleep(3000);
		cout << "Responses\n[1] *Flirt*\n[2] ..." << endl;
		cout << "Option: ";
		getline(cin, None);
		...
		while(true)
		{
			...
			{
				Sleep(3000);
				cout << "[MC]: These artist would be ashamed if they saw you.\n" << endl;
				Sleep(3000);
				cout << "[Cath]: My art is not as great as them.\n" << endl;
				Sleep(3000);
				cout << "[MC]: I'm not talking about your paintings. I'm talking about you. 'cause since you've enetered you have become the best art in the room.\n" << endl;
				Sleep(3000);
				cout << "[Cath]: *blushes*\n" << endl;
				break;
			}
		...
		Sleep(3000);
		cout << "[MC]: Hey look, they have free paint and blank canvas. You should try to paint.\n" << endl;
		Sleep(3000);
		cout << "[Cath]: Okay\n" << endl;
		Sleep(3000);
		cout << "Inner Monologue\n" << endl;
		cout << "I watched her paint a beautiful scenery. She painted two mountains, a river flowing through and the Sun.\n" << endl;
		Sleep(3000);
		cout << "[MC]: It looks beautiful. I wish I could take it home and just look at it forever. I would pour my love into it until it runs out.\n" << endl;
		Sleep(3000);
		cout << "Inner Monologue\n" << endl;
		cout << "As I was saying that I was looking at Cath. She's the one I wanted. She didn't realize I was talking about her.\n" << endl;
		Sleep(3000);
		cout << "You spend the whole morning at the art gallery\n" << endl;
		cout << "You then took her into a cafe where inside and she could freely roam around\n" << endl;
		Sleep(3000);
		cout << "[Cath]: Look! a kitty. This is overwhelming. There's so many cats here. Hello Cat, I am Cath.\n" << endl;
		Sleep(3000);
		cout << "Inner Monologue: \n" << endl;
		cout << "She looks like a kid while playing with cats. Is this her first time seeing a cat?\n" << endl;
		Sleep(3000);
		cout << "[MC]: Why don't you have a cat if you love them so much?\n" << endl;
		Sleep(3000);
		cout << "[Cath]: Remy's allergic to cats. I really want one though.\n" << endl;
		Sleep(3000);
		cout << "[MC]: Maybe we'll get a pet cat in the future.\n" << endl;
		Sleep(3000);
		cout << "[Cath]: Maybe, I guess *blushes*\n" << endl;
		Sleep(3000);
		cout << "You finished eating at the cafe. Cath didn't want to go yet. She still wants to play with the cats.\n" << endl;
		cout << "Moments later she finally decided to leave the cats. Later you both decided to walk in the park. Just a nice and relaxing walk.\n" << endl;
		Sleep(3000);
		cout << "[Cath]: I feel anxious.\n" << endl;
		Sleep(3000);
		cout << "[MC]: Are you okay? Do you want a Cat?\n" << endl;
		Sleep(3000);
		cout << "[Cath]: I just don't want this day to end yet.\n" << endl;
		Sleep(3000);
		cout << "[MC]: Well we still have a whole day in front of us. Let's go.\n" << endl; 
		Sleep(3000);
		cout << "[Cath]: But it's almost night time.\n" << endl;
		Sleep(3000);
		cout << "[MC]: It's more than enough.\n" << endl;
		Sleep(3000);
		cout << "[Cath]: More than enough for what?\n" << endl;
		Sleep(3000);
		cout << "[MC]: Nothing. Come on, follow me.\n" << endl;
		Sleep(3000);
		cout << "We ridee a train from Tokyo and go through the north\n" << endl;
		Sleep(3000);
		cout << "[Train Announcement]: Odawara Station. Odawara station. Thank you for riding Evergreen Railways.\n" << endl;
		Sleep(3000);
		cout << "[MC]: We are here.\n" << endl;
		Sleep(3000);
		cout << "[Cath]: Where are we going?\n" << endl;
		Sleep(3000);
		cout << "[MC]: Just follow me.\n" << endl;
		Sleep(3000);
		cout << "You ride a cable car. Cath was amused by the sight. You've reached the peak of the mountain and the Sun is setting.\n" << endl;
		Sleep(3000);
		cout << "[Cath]: Look, we could see that Shinto shrine below from here. The view here is great. I should remember this scene so I could paint it when we get home. Thank you so much MC because you brought me here...\n" << endl;
		Sleep(3000);
		cout << "She keeps talking, and thanking you. You noticed that she's changed, from a shy girl now she freely expresses her feelings.\n" << endl;
		Sleep(3000);
		cout << "Responses\n[1] Restart the game\n[2] Confess" << endl;
		cout << "Option: ";
		getline(cin, None);
		...
		while(true)
		{
			...
			{
				Sleep(3000);
				cout << "[MC]: Cathleah… I-I feel like I'm gonna explode. My feelings are overloaded right now. I feel so overwhelmed with emotions.\n" << endl;
				Sleep(3000);
				cout << "[MC]: We started as friends and it has grown stronger. I asked the lord for a friend but he probably likes me so much that he gave me you.\n" << endl;
				Sleep(3000);
				cout << "[MC]: There are so many ways I want to say I love you. In my eyes you're the only one I see. How lonely could the nights be If I'm not with you? I want to stay with you. Hold my hands forever and more.\n" << endl;
				void game_over();
				break;
			}
		}
